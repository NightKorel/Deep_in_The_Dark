...
const VERBOSE_RUNS = 1;   // 詳細印出「一趟趟的旅程」幾次（給人看故事）
const SILENT_RUNS = 10;   // 靜默多跑幾次，統計「每層平均打幾趟過關」（給可靠數字；卡關的輪會跑滿 MAX_DIVES 較慢，故先設 10）
const MAX_DIVES = 20;     // 單次遊玩最多下潛幾趟（超過視為卡關）
