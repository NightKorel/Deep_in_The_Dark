...
const ACHIEVEMENTS = [
  ...
  { id: "熟練者", name: "熟練者", icon: "⭐", desc: "讓任一角色歷練達到 4 級。", hint: "有人開始獨當一面。", relic: "熟練刻印", check: () => Object.values(gameState.characters).some((c) => (c.trainLevel || 1) >= 4) },
  { id: "精益求精", name: "精益求精", icon: "⚔️", desc: "把任一角色的技能全部解鎖。", hint: "每一手，都磨到出鞘。", relic: "精鍛核心", check: () => Object.keys(gameState.characters).some((id) => CHARACTERS[id].skillIds.every((sid) => isSkillUnlocked(id, sid))) },
