...
const MONSTERS = {
  ...
  刺螯: {
    ...
    codex: "比拳頭大一點，踩都能踩死。但要是被螫到，喝什麼藥都像在喝白開水，連 V 煮的酸味湯都沒味道了，超詭異的。（V：？）",
  ...
  垂垂耳: {
    ...
    codex: "毛茸茸的，大耳朵垂著，好可愛……然後牠踢裂了地上那塊石頭。欸 L 你什麼意思，我才沒有想摸！",
  ...
  擬巢怪: {
    id: "擬巢怪", name: "擬巢怪", icon: "🪺", hpRange: [23, 28],
    skillIds: ["擬巢怪_啄食", "擬巢怪_彈射", "擬巢怪_加固"],
    codex: "一叢亂糟糟的枯枝，還想說可以撿去生火。結果那「巢」站起來了。我把柴刀都丟了，跑。",
    idleLine: "擬巢怪縮成一團枯枝的模樣。",
    foodId: null, herbId: "巢絨",
  },
  掠禽: {
    id: "掠禽", name: "掠禽", icon: "🦅", hpRange: [21, 26],
    skillIds: ["掠禽_撕抓", "掠禽_俯衝", "掠禽_振翅"],
    codex: "牠不會叫。等聽見風聲，爪子已經到臉上了。",
    idleLine: "掠禽在高處盤旋，銳利的雙眼始終沒有離開你們。",
    foodId: "掠禽肉", herbId: null,
  },
  青羽: {
    id: "青羽", name: "青羽", icon: "🐦", hpRange: [20, 25],
    skillIds: ["青羽_啄", "青羽_群護", "青羽_鼓翼"],
    codex: "小小一隻藍綠色的，超可愛，還會唱歌。唱著唱著旁邊那隻的傷口就好了。……先打牠，先打牠！",
    idleLine: "青羽輕快地在同伴間跳來跳去，發出清亮的鳴唱。",
    foodId: null, herbId: "碧翎",
  },
  枝角翎: {
    id: "枝角翎", name: "枝角翎", icon: "🦉", hpRange: [26, 31],
    skillIds: ["枝角翎_角擊", "枝角翎_兀兀"],
    codex: "頭上長角的貓頭鷹。牠叫一聲『兀兀』，暗處就多站一隻一模一樣的。我數到第三隻才發現不對勁。",
    idleLine: "枝角翎一動不動地立著，頭上的岔角在陰影裡若隱若現。",
    foodId: "枝角梟肉", herbId: null,
  },
  花尾: {
    id: "花尾", name: "花尾", icon: "🦚", isBoss: true, hpRange: [160, 160],
    skillIds: ["花尾_啄擊", "花尾_羽扇", "花尾_漩渦紋", "花尾_呼喚"],
    codex: "牠展開尾羽的時候，整片風谷都會安靜下來。漂亮得不像真的——漂亮得讓人頭暈，然後你就分不清該打誰了。",
    idleLine: "花尾緩緩張開尾羽，上面的紋路像無數隻眼睛。",
    foodId: null, herbId: null,
  },
};
...
// 固定小怪組合（納可 2026-08-13 拍板）：小怪【不再隨機抽 2~3 隻】，改從每層「固定的組合清單」挑一組出。
// 好處：每場的總戰力是「已知」的 → 勝率好算、難度好調，還能刻意設計有搭配性的組合（怪互相搭）。
// 只隨機「挑哪一組」，組合內容固定。菁英節點沿用同一份、由 resolveMonsterNode 整組菁英化。
// 之後要調難度，就針對「一組一組」看勝率（scripts/難度檢查.js 可逐組跑）。
const LAYER_MOB_ENCOUNTERS = {
  1: [
    ["凝膠", "凝膠", "翅鱗"],      // 一堆軟的＋一隻快的
    ["藍顎獸", "翅鱗"],           // 肉盾＋脆皮
    ["眼藻", "眼藻"],             // 成對
