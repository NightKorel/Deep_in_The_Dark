...
const MONSTERS = {
  凝膠: {
    ...
    codex: "到處都有，走路不看地的話踩上去會滑一跤——別問我怎麼知道的。打起來不難，就是有點煩，跟甩不掉的鼻涕一樣。不知道算不算活的，反正戳了會動。",
  ...
  藍顎獸: {
    ...
    codex: "看到那個嘴你就懂了，能在石頭上留齒痕的東西。平常趴在水邊跟石頭一樣，所以第一次遇到的時候差點坐上去。……對，V 笑了很久。",
  ...
  翅鱗: {
    ...
    codex: "會飛的魚，你敢信？第一次看到的時候還以為自己摔傻了。速度是真的快，不太好打到。好在皮很薄，抓到就死。",
  ...
  眼藻: {
    ...
    codex: "遠看就是一團水藻，走近才發現上面全是眼睛——被一堆眼珠子盯著的感覺我到現在還不太習慣。長在潮濕的角落，最好別讓它們結群。",
  ...
  島鯨: {
    ...
    codex: "……說實話我也不太確定那是什麼，太大了，只看到一小部分。L 消失的那個水坑底下就是這東西。你要問我怕不怕？怕，但 L 在裡面。",
  ...
  巨岩蚺: {
    ...
    codex: "岩洞最深處那條纏在石柱上的「石柱」，其實是牠。跟岩壁同一個顏色，會叫岩石當幫手，還會把幫手一口吞回去補血——第一次看到差點沒把胃裡的東西吐出來。壓在牠身下的感覺，我不想再體驗第二次。",
